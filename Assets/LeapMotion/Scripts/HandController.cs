...
public class HandController : MonoBehaviour {
  ...
  protected bool flag_initialized_ = false;
  protected long prev_graphics_id_ = 0;
  protected long prev_physics_id_ = 0;
  ...
  */
  ...
  //   udp = new udpSocket("127.0.0.1", 8001);
